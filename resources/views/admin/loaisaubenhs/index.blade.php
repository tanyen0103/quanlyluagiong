    ...
    <div class="nav-breadcrumb bg-gray-100 text-lg">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb ">
                ...
                <li class="breadcrumb-item active" aria-current="page">Loại sâu bệnh</li>
            </ol>
        </nav>
    </div>
                            ...
                            @role('Admin')
                                <td>
                                    <form action="{{ route('loaisaubenhs.destroy',$item->id) }}" method="POST">
                                        ...
                                        <a class="btn btn-info mt-1" href="{{ route('loaisaubenhs.show',$item->id) }}"><i class="fas fa-eye" title="chi tiết"></i></a>

                                        <a class="btn btn-primary mt-1" href="{{ route('loaisaubenhs.edit',$item->id) }}" ><i class="fas fa-pen" title="chỉnh sửa"></i></a>
