                            ...
                            @role('Admin')
                                <td>
                                    <form action="{{ route('loaigiatridos.destroy',$item->id) }}" method="POST">
                                        ...
                                        <a class="btn btn-info mt-1" href="{{ route('loaigiatridos.show',$item->id) }}"><i class="fas fa-eye" title="chi tiết"></i></a>

                                        <a class="btn btn-primary mt-1" href="{{ route('loaigiatridos.edit',$item->id) }}" ><i class="fas fa-pen" title="chỉnh sửa"></i></a>
