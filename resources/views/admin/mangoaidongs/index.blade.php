    ...
    <div class="nav-breadcrumb bg-gray-100 text-lg">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb ">
                ...
                <li class="breadcrumb-item active" aria-current="page">Mã ngoài đồng</li>
            </ol>
        </nav>
    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('mangoaidongs.destroy',$item->id) }}" method="POST">
                                        ...
                                        <a class="btn btn-info mt-1" href="{{ route('mangoaidongs.show',$item->id) }}"><i class="fa-regular fa-eye" title="chi tiết"></i></a>

                                        <a class="btn btn-primary mt-1" href="{{ route('mangoaidongs.edit',$item->id) }}" ><i class="fa-solid fa-pen-to-square" title="chỉnh sửa"></i></a>
