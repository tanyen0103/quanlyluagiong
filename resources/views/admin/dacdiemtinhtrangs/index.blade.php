                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('dacdiemtinhtrangs.destroy',$item->id) }}" method="POST">
                                    ...
                                    <a class="btn btn-info mt-1" href="{{ route('dacdiemtinhtrangs.show',$item->id) }}"><i class="fas fa-eye" title="chi tiết"></i></a>

                                    <a class="btn btn-primary mt-1" href="{{ route('dacdiemtinhtrangs.edit',$item->id) }}" ><i class="fas fa-pen" title="chỉnh sửa"></i></a>
