    ...
    <div class="row pt-2">
        <div class="col-lg-12 d-flex justify-content-between">
            <div class="text-center text-success">
                <h2>GIÁ TRỊ TÍNH TRẠNG</h2>
            </div>
            <div class="">
                <a class="btn btn-warning" href="{{ route('giatritinhtrangs.create') }}">TẠO MỚI</a>
            </div>
        </div>
    </div>
        ...
        <tr>
            ...
            <td>
                <form action="{{ route('giatritinhtrangs.destroy',$item->id) }}" method="POST">
                    ...
                    <a class="btn btn-success" href="{{ route('giatritinhtrangs.show',$item->id) }}">Chi tiết</a>

                    <a class="btn btn-warning" href="{{ route('giatritinhtrangs.edit',$item->id) }}">Sửa</a>
