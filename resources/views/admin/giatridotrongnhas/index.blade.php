                        ...
                        <tr>
                            ...
                            <td>
                                <form class="d-flex"  action="{{ route('giatridotrongnhas.destroy',$item->id) }}" method="POST">
                                    ...
                                    <a class="btn btn-info mt-1 mr-1" href="{{ route('giatridotrongnhas.show',$item->id) }}"><i class="fas fa-eye" title="chi tiết"></i></a>

                                    <a class="btn btn-primary mt-1 mr-1" href="{{ route('giatridotrongnhas.edit',$item->id) }}" ><i class="fas fa-pen" title="chỉnh sửa"></i></a>
