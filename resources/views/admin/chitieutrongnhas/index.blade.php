                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('chitieutrongnhas.destroy',$item->id) }}" method="POST">
                                    ...
                                    <a class="btn btn-info mt-1" href="{{ route('chitieutrongnhas.show',$item->id) }}"><i class="fas fa-eye" title="chi tiết"></i></a>

                                    <a class="btn btn-primary mt-1" href="{{ route('chitieutrongnhas.edit',$item->id) }}" ><i class="fas fa-pen" title="chỉnh sửa"></i></a>
